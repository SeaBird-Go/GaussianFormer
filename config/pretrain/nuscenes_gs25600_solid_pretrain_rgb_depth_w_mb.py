...
Date: 2025-03-12 11:39:18
Email: haimingzhang@link.cuhk.edu.cn
Description: Pretrain the GaussinFormer by image and depth reconstruction from 3DGS with 
memory bank for information interaction.
'''
_base_ = [
    '../_base_/misc.py',
    '../_base_/model.py',
