...
Date: 2025-04-01 16:20:37
Email: haimingzhang@link.cuhk.edu.cn
Description: Use the Chamfer distance loss to constrain the centers distribution of 
3DGS.
'''
_base_ = [
    '../_base_/misc.py',
...
loss = dict(
    ...
    loss_cfgs=[
        dict(
            ...
            weight=0.1,
            input_dict=dict(
                gt_pts='filter_points',
                pred_pts='representation')
        ),
        dict(
