...
Date: 2025-03-06 19:56:20
Email: haimingzhang@link.cuhk.edu.cn
Description: The number of queries is 12500, and the render image size is
216x400, and the number of decoder layers is 2.
'''
_base_ = [
    '../_base_/misc.py',
    '../_base_/model.py',
